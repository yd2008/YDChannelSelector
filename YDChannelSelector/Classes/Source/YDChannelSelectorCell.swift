    ...
    public var cellType: YDChannelSelectorCellType? {
        didSet{
            ...
            case .add?:
                ...
                let imagePath = bundle.path(forResource: "selector_add.png", ofType: nil, inDirectory: "YDChannelSelector.bundle")
            ...
            case .delete?:
                if isFixation {
                    ...
                    let bundel = Bundle(for: YDChannelSelector.self)
                    let imagePath = bundel.path(forResource: "selector_delete.png", ofType: nil, inDirectory: "YDChannelSelector.bundle")
                    let image = UIImage(contentsOfFile: imagePath!)
                    iconView.image = image
                }
            default: break
